      ...
      <div className="max-w-7xl mx-auto px-6 pb-14">
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          <FadeIn delay={0} direction="up">
            <BenefitCard
              icon={<GraduationCap className="w-6 h-6 text-[#027027]" />}
            >
          ...
          <FadeIn delay={100} direction="up">
            <BenefitCard icon={<Users className="w-6 h-6 text-[#027027]" />}>
              ...
              <p className="text-gray-600 leading-relaxed">
                Enhanced visibility through NIMA's exclusive member directory
                and outreach programs, connecting you with patients seeking
          ...
          <FadeIn delay={200} direction="up">
            <BenefitCard
              icon={<Handshake className="w-6 h-6 text-[#027027]" />}
            >
          ...
          <FadeIn delay={300} direction="up">
            <BenefitCard
              icon={<HeartHandshake className="w-6 h-6 text-[#027027]" />}
            >
              <h3 className="text-xl font-bold mb-4">
                Philanthropic Opportunities
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Participate in healthcare initiatives that give back to the
                Nevada community, providing care for the underserved and
                supporting future medical students through scholarships.
              </p>
            </BenefitCard>
          </FadeIn>
        </div>
